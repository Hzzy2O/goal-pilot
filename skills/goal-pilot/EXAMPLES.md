...
### User
```
Done with task 1 and 2. Task 2 went well, got a verbal commit for paid plan!
```
...
### User
```
That's it for today. Done with task 3 as well.
```
...
### User
```
I want to change my goal completely. Reset everything.
```
...
**Type "confirm reset" to proceed**, or tell me if you'd like to modify your existing goal instead.
```
